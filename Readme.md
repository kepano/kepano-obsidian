...
I use very few folders. My personal notes such as journal entries are primarily in the root. Folders are for everything else. These are the folders I use:
